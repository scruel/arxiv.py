...
class RateLimiter:
    def __init__(self, delay_seconds: float = 3.0) -> None:
        """
        delay_seconds: Number of seconds to wait between API requests.
...
class Client:
    ...
    def __init__(
            ...
            page_size: int = 100, num_retries: int = 3
        ):
        """
    ...
    def __repr__(self) -> str:
        return "{}(page_size={}, num_retries={})".format(
            _classname(self),
            repr(self.page_size),
    ...
    def __try_parse_feed(
        ...
        """
        Recursive helper for _parse_feed. 
        """
